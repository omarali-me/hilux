...
@Component({
  selector: 'app-single-application-search',
  templateUrl: './single-application-search.component.html',
  styleUrls: ['./single-application-search.component.css']
})
export class SingleApplicationSearchComponent implements OnInit {
  formData: any = {};
  formErrors: any = {};
