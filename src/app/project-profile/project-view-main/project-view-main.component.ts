...
@Component({
  selector: 'app-project-view-main',
  templateUrl: './project-view-main.component.html',
  styleUrls: ['./project-view-main.component.css']
})
export class ProjectViewMainComponent implements OnInit {
  formData: any;
  searchData: any = {};
  formErrors:any = {};
